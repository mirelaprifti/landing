const AI_BENEFITS = [
  {
    ...
    description: "Every operation follows a declarative pattern — no guesswork for LLMs.",
    icon: "ri-layout-grid-line"
  },
  {
    title: "Typed feedback loop",
    description: "Detailed error traces show what failed, enabling precise self-repair.",
    icon: "ri-refresh-line"
  },
  {
    title: "Built-in reliability",
    description: "Error handling, supervision, and recovery — production-ready by default.",
    icon: "ri-shield-check-line"
  },
  {
    title: "Rich toolbox",
    description: "Schema validation to workflows in a language LLMs easily understand.",
    icon: "ri-tools-line"
  }
];
      ...
      <div className="mx-auto w-full max-w-[73.75rem] px-4">
        ...
        <div className="mb-16 max-w-2xl">
          ...
          <p className="mt-4 text-lg text-zinc-500">
            Effect's declarative patterns and rich type information make it ideal for AI-assisted development.
            LLMs understand Effect code better and produce more reliable results.
          </p>
        </div>
            ...
            >
              ...
              <div className="mb-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <div className="text-sm font-medium text-white">Ben Davis</div>
              ...
              <p className="text-sm leading-relaxed text-zinc-300">
                <span className="text-zinc-500">@MichaelArnaldi</span> suggested cloning
                the effect repo as a git subtree, giving it to Claude, then using that as docs.
                It sounds absurd, but it's actually kind amazing...
              </p>
