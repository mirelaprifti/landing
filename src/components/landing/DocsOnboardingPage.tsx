	...
	return (
		<DocsLayout activeSlug="onboarding" tocItems={TOC}>
			<article>
				...
				{/* Why Effect */}
				<section id="why-effect" className="mt-12 max-w-3xl">
					<h2 className="text-2xl font-semibold tracking-tight">Why Effect?</h2>
				...
				<section id="learning-path" className="mt-12 max-w-4xl">
					...
					<p className="mt-6 max-w-2xl text-base leading-relaxed text-zinc-700 dark:text-zinc-300">
						Effect rewards learning in order: each step builds on the one before
						it. Following this spine takes most developers a few focused days;
						everything else branches off from it.
					</p>
				...
				{/* Next steps */}
				<section id="keep-going" className="mt-12 max-w-4xl">
					<h2 className="text-2xl font-semibold tracking-tight">Keep Going</h2>
				...
				{/* Community */}
				<section id="join-our-community" className="mt-12 max-w-3xl">
					<h2 className="text-2xl font-semibold tracking-tight">
						Join our Community
					</h2>
