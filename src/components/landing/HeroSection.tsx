...
const HERO_LOGOS: { name: string; src: string; h: string; invert?: boolean }[] = [
	{ name: "opencode", src: "/assets/effect-jobs-logos/opencode-wordmark-dark.svg", h: "16px" },
	{ name: "T3 Chat", src: "/assets/test-logos/t3-chat.png", h: "12px", invert: true },
	{ name: "Cloudflare", src: "/assets/effect-jobs-logos/Cloudflare_logo_horizontal_wht 1.png", h: "16px" },
	{ name: "Vercel", src: "/assets/quotes-logos/vercel-logotype-dark.svg", h: "16px" },
	{ name: "MasterClass", src: "/assets/quotes-logos/masterclass-noM.svg", h: "12px" },
];
