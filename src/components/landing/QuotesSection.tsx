	...
	const quotes = [
		{
			...
			company: "Cloudflare",
			logo: getAssetPath("/assets/Cloudflare_logo_wht 2.svg"),
		},
		{
		...
		},
		{
			...
			logo: getAssetPath("/assets/logos/total-typescript-logo.png"),
		},
		{
			text: "Perhaps the most ergonomic and safe method of Dependency Injection I've ever seen.",
			author: "Cor",
			company: "Union Build",
			logo: getAssetPath("/assets/logos/union-build.svg"),
		},
		{
		...
		},
		{
			...
			company: "Astro",
			logo: getAssetPath("/assets/Astro.svg"),
		},
	];
