...
const MYTHS: Myth[] = [
	...
	},
	{
		...
		body: [
			"The full Effect ecosystem is extensive, but you don't require all of it to be productive. You can start with 10–20 core functions and progressively add more capabilities, similar to learning TypeScript without knowing every npm package.",
		],
	},
	{
		id: "bundle-size",
