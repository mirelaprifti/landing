...
function FeaturedPost({ post }: { post: BlogPost }) {
	...
	return (
		<a
			...
			className="group relative block overflow-hidden rounded-md border border-zinc-300 dark:border-zinc-700 bg-zinc-100/40 dark:bg-[#141315] transition-colors duration-200 hover:border-zinc-400 dark:hover:border-zinc-600 hover:bg-zinc-100/70 dark:hover:bg-[#0F0F11]"
		>
...
function PostCard({ post }: { post: BlogPost }) {
	...
	return (
		<a
			href={isExternal ? url : getAssetPath(url)}
			{...(isExternal ? { target: "_blank", rel: "noopener noreferrer" } : {})}
			className="group block -mx-4 border-t border-zinc-300/80 dark:border-zinc-700/80 px-4 py-6 transition-colors first:border-t-0 hover:bg-zinc-100/60 dark:hover:bg-[#141315]"
		>
