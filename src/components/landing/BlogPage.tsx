...
function FeaturedPost({ post }: { post: BlogPost }) {
	...
	return (
		<a
			...
			className="group relative block overflow-hidden rounded-md border border-zinc-300 dark:border-zinc-700 bg-[#F7F7F8] dark:bg-[#141315] transition-colors duration-200 hover:border-zinc-400 dark:hover:border-zinc-600 hover:bg-zinc-100 dark:hover:bg-[#0F0F11]"
		>
