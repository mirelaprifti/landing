...
export const BLOG_PROSE_CLASS =
	"prose prose-zinc prose-headings:font-semibold prose-headings:tracking-tight prose-headings:leading-tight prose-h2:mt-16 prose-h2:mb-4 prose-h2:text-2xl prose-h3:mt-12 prose-h3:mb-3 prose-h3:text-xl prose-p:my-6 prose-p:text-zinc-700 prose-p:text-lg prose-p:leading-normal prose-a:text-zinc-900 prose-a:underline prose-a:decoration-zinc-300 prose-a:underline-offset-4 hover:prose-a:decoration-zinc-600 prose-strong:text-zinc-900 prose-code:rounded-md prose-code:bg-zinc-100 prose-code:px-2 prose-code:py-1 prose-code:font-mono prose-code:text-sm prose-code:text-zinc-800 prose-code:before:content-none prose-code:after:content-none prose-pre:my-8 prose-pre:rounded-xl prose-pre:border prose-pre:border-zinc-200 prose-pre:bg-zinc-50 prose-pre:text-sm prose-pre:leading-[1.6] prose-ul:my-6 prose-ol:my-6 prose-li:my-0.5 prose-li:text-zinc-700 prose-li:text-lg prose-li:leading-normal prose-hr:my-12 prose-hr:border-zinc-200 prose-h4:mt-8 prose-h4:mb-2 prose-h4:text-lg prose-li:marker:text-zinc-400 prose-blockquote:my-8 prose-blockquote:border-l-2 prose-blockquote:border-zinc-300 prose-blockquote:pl-6 prose-blockquote:font-normal prose-blockquote:not-italic prose-blockquote:text-zinc-600 prose-img:my-8 prose-img:rounded-md prose-figure:my-8 prose-figcaption:mt-3 prose-figcaption:text-sm prose-figcaption:text-zinc-500 prose-table:my-8 prose-table:text-base prose-th:text-left prose-th:font-semibold prose-th:text-zinc-900 prose-td:text-zinc-700 dark:prose-invert dark:prose-p:text-zinc-400 dark:prose-a:text-zinc-200 dark:prose-a:decoration-zinc-400 dark:hover:prose-a:decoration-zinc-300 dark:prose-strong:text-zinc-200 dark:prose-code:bg-zinc-800 dark:prose-code:text-zinc-200 dark:prose-pre:border-zinc-800 dark:prose-pre:bg-zinc-900/80 dark:prose-li:text-zinc-400 dark:prose-hr:border-zinc-800 dark:prose-li:marker:text-zinc-500 dark:prose-blockquote:border-zinc-700 dark:prose-blockquote:text-zinc-400 dark:prose-figcaption:text-zinc-500 dark:prose-th:text-zinc-200 dark:prose-td:text-zinc-400";
