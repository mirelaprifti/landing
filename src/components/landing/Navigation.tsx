					...
					>
						<nav className="flex h-16 items-center">
							...
							{logoSuffix && (
								...
								<span
									className={`ml-3 translate-y-[2.7px] font-mono text-[18.75px] leading-[13.7px] font-medium tracking-wider uppercase ${transparent ? "text-white/80" : "text-zinc-500 dark:text-zinc-400"}`}
								>
									/ {logoSuffix}
								</span>
							)}
