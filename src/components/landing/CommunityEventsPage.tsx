					...
					<div className="relative mx-auto w-full max-w-[73.75rem] px-4">
						<div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2">
							...
							<div>
								...
								<p className="mt-6 text-lg leading-relaxed text-zinc-400 md:max-w-[41.667%] lg:max-w-[83.333%]">
						...
						<div className="grid grid-cols-1 items-center gap-6 md:grid-cols-12 md:gap-x-6 md:gap-y-8">
							...
							<div className="md:col-span-6">
								...
								<p className="mt-4 text-lg leading-normal text-zinc-400">
									Talks are how local communities get started, and we'd love
									to see yours grow.
								</p>
							</div>

							{/* CTA — corner-bracket box, mirrors the blog post page */}
							<div className="md:col-span-4 md:col-start-9 md:mt-[41px] md:self-start">
