			...
			<div className="relative mx-auto w-full max-w-295 px-4">
				<div className="grid grid-cols-1 md:grid-cols-2 gap-12">
					...
					<div>
						...
						<h2 className="text-2xl leading-tighter font-semibold text-zinc-900 dark:text-white md:text-3xl max-w-lg">
					...
					<div className="flex items-center justify-center">
						<div className="relative w-full max-w-md">
							...
							<div className="group relative w-full border border-zinc-300 dark:border-zinc-700 bg-zinc-100/50 dark:bg-zinc-900/50 px-6 py-4 font-mono text-base text-center transition-all hover:border-zinc-400 dark:hover:border-zinc-500 hover:bg-zinc-200/50 dark:hover:bg-zinc-800/50">
								...
								<span className="text-zinc-600 dark:text-zinc-400">, </span>
								<span
									className={`cursor-pointer transition-opacity text-red-600 dark:text-red-400 ${hoveredType && hoveredType !== "error" ? "opacity-50" : "opacity-100"}`}
								...
								<span className="text-zinc-600 dark:text-zinc-400">, </span>
								<span
									className={`cursor-pointer transition-opacity text-violet-600 dark:text-violet-400 ${hoveredType && hoveredType !== "requirements" ? "opacity-50" : "opacity-100"}`}
							...
							<div className="mt-8 ring-1 ring-inset ring-zinc-300 dark:ring-zinc-700 bg-zinc-100/50 dark:bg-zinc-900/50 p-6 font-mono text-sm">
								<div>
