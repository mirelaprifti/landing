...
const AIRPORTS = [
	{
		...
		intro: "The closest and most convenient airport.",
		train:
			...
			<main id="main-content" className="relative z-10 w-full pt-16">
				...
				<section id="airports" className={`scroll-mt-16 ${sectionRhythm}`}>
					<div className={container}>
						...
						{/* Route map — node positions derived from real coordinates */}
						<div className={`${card} mt-12`}>
							<p className={text.micro}>Airport connections to Livorno</p>
							<svg
								viewBox="0 0 600 400"
								className="mt-4 w-full"
								role="img"
								aria-label="Map showing connections from Pisa, Florence, and Bologna airports to Livorno"
							>
								{/* Coastline */}
								<path
									d="M 150 0 C 118 70, 96 140, 99 200 C 102 258, 90 300, 76 340 C 70 358, 72 380, 80 400"
									fill="none"
									strokeWidth="1.5"
								...
								<text
									...
									fontSize="10"
									letterSpacing="2"
									className="fill-zinc-400 font-mono uppercase dark:fill-zinc-600"
								>
									Tyrrhenian
								</text>
								<text
								...
								<text
									...
									y="342"
									fontSize="10"
									className="fill-zinc-500 font-mono uppercase dark:fill-zinc-400"
								>
									30-40 min
								</text>
								<text
								...
								<rect
									...
									width="8"
									height="8"
									className="fill-white stroke-zinc-500 dark:fill-zinc-950 dark:stroke-zinc-400"
									strokeWidth="1.5"
								/>
								<rect
									x="482"
								...
								<text
									...
									y="314"
									fontSize="11"
									className="fill-zinc-700 font-mono uppercase dark:fill-zinc-200"
								>
									Pisa · PSA
								</text>
								<text
								...
								<text
									...
									fontSize="12"
									fontWeight="600"
									className="fill-zinc-900 font-mono uppercase dark:fill-white"
								>
									Livorno
								</text>
							</svg>
