						...
						<div className="flex flex-col items-center text-center">
							...
							{featuredPartner?.contactEmail && (
								<button
									...
									className="group mt-[37px] flex w-full max-w-[396px] cursor-pointer items-center justify-between gap-3 border border-zinc-700 bg-zinc-900/60 px-4 py-4 font-mono text-base text-white backdrop-blur-sm transition-colors hover:border-zinc-500 hover:bg-zinc-900"
								>
									{featuredPartner.contactEmail}
									{emailCopied ? (
										<i
