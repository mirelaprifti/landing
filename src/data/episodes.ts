...
https://github.com/rankincodes`,
    chapters: [
      ...
      { time: "01:45", title: "Adam's professional background and early startup experience" },
      { time: "08:18", title: "Warp's founding story and mission" },
      { time: "17:36", title: "What drew Warp to Effect as a solution" },
      { time: "29:24", title: "Initial Steps with Effect (AI browser automation project)" },
...
effect-messaging: https://github.com/spiko-tech/effect-messaging`,
    chapters: [
      { time: "00:00", title: "Introduction and rationale behind Spiko's selection of Effect" },
      { time: "07:22", title: "Onboarding engineers without prior Effect knowledge" },
      { time: "10:06", title: "Spiko's architectural design and applications" },
      { time: "15:12", title: "Event-driven system architecture" },
      { time: "22:45", title: "Rationale for choosing RabbitMQ over alternative message brokers" },
      { time: "28:26", title: "Development and motivation behind the effect-messaging library" },
      { time: "39:53", title: "Effect Schema, versioning, and asynchronous messaging patterns" },
...
Github: https://github.com/davidgoli`,
  ...
  },
  {
    ...
    chapters: [
      ...
      { time: "01:54", title: "Michael's background: from mathematics research to AI entrepreneurship" },
      { time: "03:49", title: "Markprompt overview and use cases for customer support automation" },
      { time: "07:45", title: "System architecture breakdown" },
      { time: "10:22", title: "Challenges unique to AI-powered support systems" },
      { time: "13:20", title: "How Effect improves reliability through dependency injection and testing" },
      { time: "16:41", title: "Technical architecture deep dive" },
      { time: "19:51", title: "Application server and RPC implementation details" },
      { time: "23:50", title: "Data ingestion engine and long-running workflows" },
      { time: "26:29", title: "Onboarding engineers new to Effect" },
      { time: "30:51", title: "Migration strategy from existing codebase to Effect" },
      { time: "35:19", title: "Effect's schema system in production environments" },
